--[[
	...
	Github Link: https://github.com/Kenji-Shore/Roblox-Client-Server-Time-Sync-Module
...
local clockSyncSignal = replicatedStorage:WaitForChild("Events"):WaitForChild("ClockSync")
